...
convertImages("characters", { resize: { height: 40 }});
...
convertImages("icons", { resize: { height: 40 }});
...
convertSingleImage("knuckles-woah.png", { resize: { height: 300 }, quality: 50 });
...
convertSingleImage("q9283rw8fg/vaporwave-wallpaper.jpg", { resize: { height: 1000 }, quality: 80 });