				...
				>
					<tbody>
						...
						<NoteRow>
							...
							repeated.
							<br />
							Misfire has a 1/8 chance and the chance for Misfire increases on
							every consecutive regular Green Missile. This means that at the
							start of a match or after a Misfire the chance is 1/8, then 1/7
							etc. until the ninth Green Missile is a{" "}
							<strong>100% guaranteed Misfire</strong>.
						</NoteRow>
						<tr>
							<td>
