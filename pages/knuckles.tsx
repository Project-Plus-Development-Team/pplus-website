...
function InfoElement({ title, children, image, position }) {
  const imageComponent =
    <Media.Item renderAs="figure" position={position}>
      <Image src={`images/knuckles/${image}`} style={{
        width: 300
      }}/>
    </Media.Item>;
      ...
      <Container>
        ...
        <Columns>
          <Columns.Column size={4}>
            <Image className="knux-main" src="/images/knuckles/glowy.png"/>
          </Columns.Column>

          <Columns.Column>
            <InfoElement title="overview" image="punch.png" position="left">
            ...
            <InfoElement title="rougher than the rest of 'em" image="upsmash.png" position="right">
        ...
        <InfoElement title="drill claw" image="drill-claw.png" position="left">
        ...
        <InfoElement title="glide" image="glide.png" position="right">
